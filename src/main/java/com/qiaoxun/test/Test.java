...
import com.qiaoxun.dao.QiswlManhuaDao;
import com.qiaoxun.pojo.QiswlCapterWithBLOBs;
import com.qiaoxun.pojo.QiswlManhua;
...
public class Test {
    ...
    public static void parse() throws IOException {
        ...
        qiswlManhua.setCreateTime(df.format(new Date()));
        qiswlManhua.setUpdateTime(df.format(new Date()));*/
        ...
        for (int i=1;i<=elements.size();i++) {
            ...
            /*for (int q=1;q<=chapters;q++){
                ...
                for (int j=1;j<=elements2.size();j++){
                    ...
                    //下载每个章节里的图片
                    DownloadImg.download3(imgUrl,i,q,j);
                }
            }*/
